  ...
  def create
    ...
    respond_to do |format|
      if @presentation.save
        format.html { redirect_to view_presentation_path(@presentation), notice: 'Presentation was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @presentation.update_attributes(params[:presentation])
        format.html { redirect_to view_presentation_path(@presentation), notice: 'Presentation was successfully updated.' }
